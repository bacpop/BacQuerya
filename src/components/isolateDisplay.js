            ...
            <div className="isolate-grid">
                ...
                <div className="sequence-stats">
                    <h5>Scaffold stats</h5>
                        ...
                        <p>Number of contigs: {props.isolateInfo.scaffold_stats.sequence_count}</p>
                        <p>Longest contig length: {props.isolateInfo.scaffold_stats.longest}</p>
                        <p>Shortest contig length: {props.isolateInfo.scaffold_stats.shortest}</p>
                        <p>Mean contig length: {props.isolateInfo.scaffold_stats.mean}</p>
                    <h5>Contig stats</h5>
